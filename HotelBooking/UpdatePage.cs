...
namespace HotelBooking
{
    public partial class UpdatePage : Form
    {
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand("UPDATE customer_table " +
                "SET customerName=@customerName, phoneNo = @phoneNo, email = @email " +
                "WHERE idNo=@idNo", conn);
            cmd.Parameters.AddWithValue("@idNo", textBoxID.Text);
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            conn.ConnectionString = CONNECTION_STRING;
            conn.Open();
            SqlCommand cmd = new SqlCommand("DELETE customer_table " +
                                            "WHERE idNo = @idNo", conn);
